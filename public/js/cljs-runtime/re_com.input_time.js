 ...
 */
re_com.input_time.triple__GT_time = (function re_com$input_time$triple__GT_time(p__15447){
var vec__15449 = p__15447;
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15449,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15449,(1),null);
var mi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15449,(2),null);
return ((hr * (100)) + mi);
});
...
if(cljs.core.truth_((function (){var and__5000__auto__ = callback;
...
var len__5726__auto___15584 = arguments.length;
var i__5727__auto___15589 = (0);
while(true){
if((i__5727__auto___15589 < len__5726__auto___15584)){
args__5732__auto__.push((arguments[i__5727__auto___15589]));

var G__15590 = (i__5727__auto___15589 + (1));
i__5727__auto___15589 = G__15590;
continue;
} else {
}
break;
...
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});

(re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic = (function (p__15510){
var map__15511 = p__15510;
var map__15511__$1 = cljs.core.__destructure_map(map__15511);
var args = map__15511__$1;
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15511__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15511__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15511__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var or__5002__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.input_time.input_time_args_desc),args));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = re_com.input_time.validate_arg_times(re_com.util.deref_or_value(model),minimum,maximum,args);
...
return (function() { 
var re_com$input_time$input_time_render__delegate = function (p__15515){
var map__15516 = p__15515;
var map__15516__$1 = cljs.core.__destructure_map(map__15516);
var args__$1 = map__15516__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var maximum__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15516__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var show_icon_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,new cljs.core.Keyword(null,"show-icon?","show-icon?",-756836459));
var minimum__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15516__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var or__5002__auto____$2 = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.input_time.input_time_args_desc),args__$1));
if(cljs.core.truth_(or__5002__auto____$2)){
return or__5002__auto____$2;
} else {
var or__5002__auto____$3 = re_com.input_time.validate_arg_times(re_com.util.deref_or_value(model__$1),minimum__$1,maximum__$1,args__$1);
...
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.h_box,new cljs.core.Keyword(null,"src","src",-1651076051),src,new cljs.core.Keyword(null,"debug-as","debug-as",283322354),(function (){var or__5002__auto____$4 = debug_as;
...
return null;
})], null),attr], 0))], null),(cljs.core.truth_(show_icon_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__15534 = "time-icon";
var G__15535 = "rc-time-icon-container";
var G__15536 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"time-icon-container","time-icon-container",-618054982),new cljs.core.Keyword(null,"class","class",-2030961996)], null));
return (re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$3 ? re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$3(G__15534,G__15535,G__15536) : re_com.theme.merge_class.call(null,G__15534,G__15535,G__15536));
})(),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"time-icon-container","time-icon-container",-618054982),new cljs.core.Keyword(null,"style","style",-496642736)], null),cljs.core.PersistentArrayMap.EMPTY)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"time-icon-container","time-icon-container",-618054982),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__15541 = "zmdi";
var G__15542 = "zmdi-hc-fw-rc";
var G__15543 = "zmdi-time";
var G__15544 = "rc-time-icon";
var G__15545 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"time-icon","time-icon",-140078298),new cljs.core.Keyword(null,"class","class",-2030961996)], null));
return (re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$5 ? re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$5(G__15541,G__15542,G__15543,G__15544,G__15545) : re_com.theme.merge_class.call(null,G__15541,G__15542,G__15543,G__15544,G__15545));
...
while (G__15648__i < G__15648__a.length) {G__15648__a[G__15648__i] = arguments[G__15648__i + 0]; ++G__15648__i;}
  p__15515 = new cljs.core.IndexedSeq(G__15648__a,0,null);
} 
return re_com$input_time$input_time_render__delegate.call(this,p__15515);};
re_com$input_time$input_time_render.cljs$lang$maxFixedArity = 0;
re_com$input_time$input_time_render.cljs$lang$applyTo = (function (arglist__15650){
var p__15515 = cljs.core.seq(arglist__15650);
return re_com$input_time$input_time_render__delegate(p__15515);
});
...
/** @this {Function} */
(re_com.input_time.input_time.cljs$lang$applyTo = (function (seq15508){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15508));
}));
