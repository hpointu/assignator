...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13602 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13602(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13604 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13604(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13606 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13606(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13607 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13607(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13611 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13611(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13614 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13614(reader);
}
});
...
var G__13633 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13634 = s.append(c);
c = G__13633;
s = G__13634;
continue;
}
