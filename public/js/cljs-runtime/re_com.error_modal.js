...
var props = map__15767__$1;
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15767__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
...
args__5732__auto__.push((arguments[i__5727__auto___15813]));
...
return re_com.error_modal.error_modal.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});

(re_com.error_modal.error_modal.cljs$core$IFn$_invoke$arity$variadic = (function (p__15780){
var map__15781 = p__15780;
var map__15781__$1 = cljs.core.__destructure_map(map__15781);
var args = map__15781__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),true);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var pre_theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"pre-theme","pre-theme",-1454266181));
var engineers_notified_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"engineers-notified?","engineers-notified?",1421448285),true);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var bug_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"bug?","bug?",1202760128),true);
var implications_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"implications-title","implications-title",-936575167),"Implications");
var undone_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"undone?","undone?",-1342458015));
var implications = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"implications","implications",-1275270911));
var what_to_do = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"what-to-do","what-to-do",-1372507613));
var triangle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"triangle","triangle",-1828376667));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var inner_wrapper = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"inner-wrapper","inner-wrapper",1366997544));
var proceedable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"proceedable?","proceedable?",1701539112));
var instructions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"instructions","instructions",1724333802));
var ask_to_report_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"ask-to-report?","ask-to-report?",-870526709));
var what_to_do_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"what-to-do-title","what-to-do-title",1255991148),"What Should You Do Now?");
var what_happened = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"what-happened","what-happened",1302018349));
var header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"header","header",119441134));
var modal = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"modal","modal",-1031880850));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"title","title",636505583),"Sorry, you've hit a bug");
var details_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"details-title","details-title",634180784),"Low-level Details (for developers):");
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var top_bar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"top-bar","top-bar",-1709393391));
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"details","details",1956795411));
var what_happened_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"what-happened-title","what-happened-title",-1667989325),"What Just Happened?");
var defaults_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"defaults?","defaults?",-972070733),true);
var backdrop_on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"backdrop-on-click","backdrop-on-click",-1460240426));
var severity = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15781__$1,new cljs.core.Keyword(null,"severity","severity",175684886),new cljs.core.Keyword(null,"error","error",-978969032));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var title_wrapper = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"title-wrapper","title-wrapper",-118118185));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15781__$1,new cljs.core.Keyword(null,"action","action",-811238024));
var theme__$1 = re_com.theme.comp(pre_theme,theme);
var part = (function() { 
var G__15827__delegate = function (part_value,p__15786){
var map__15789 = p__15786;
var map__15789__$1 = cljs.core.__destructure_map(map__15789);
var opts = map__15789__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15789__$1,new cljs.core.Keyword(null,"props","props",453281727));
return re_com.util.part.cljs$core$IFn$_invoke$arity$2(part_value,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([opts,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"theme","theme",-1247880880),theme__$1,new cljs.core.Keyword(null,"props","props",453281727),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"re-com","re-com",-2034768951),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error-modal","error-modal",214887023),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"severity","severity",175684886),severity], null)], null)], null),props], 0))], null)], 0)));
};
var G__15827 = function (part_value,var_args){
var p__15786 = null;
if (arguments.length > 1) {
var G__15833__i = 0, G__15833__a = new Array(arguments.length -  1);
while (G__15833__i < G__15833__a.length) {G__15833__a[G__15833__i] = arguments[G__15833__i + 1]; ++G__15833__i;}
  p__15786 = new cljs.core.IndexedSeq(G__15833__a,0,null);
} 
return G__15827__delegate.call(this,part_value,p__15786);};
G__15827.cljs$lang$maxFixedArity = 1;
G__15827.cljs$lang$applyTo = (function (arglist__15834){
var part_value = cljs.core.first(arglist__15834);
var p__15786 = cljs.core.rest(arglist__15834);
return G__15827__delegate(part_value,p__15786);
});
...
var arrow_points = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(arrow_midpoint),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arrow_midpoint)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arrow_side_length),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0))," ","0,0"].join('');
var what_happened__$1 = (function (){var or__5002__auto__ = what_happened;
...
var implications__$1 = (function (){var or__5002__auto__ = implications;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
if(cljs.core.truth_(defaults_QMARK_)){
...
var what_to_do__$1 = (function (){var or__5002__auto__ = what_to_do;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
if(cljs.core.truth_(defaults_QMARK_)){
if(cljs.core.truth_(proceedable_QMARK_)){
return "You might be able to close this pop-up and continue on. Otherwise, restart this app.";
} else {
return "You'll have to restart this app.";
}
} else {
return null;
}
...
/** @this {Function} */
(re_com.error_modal.error_modal.cljs$lang$applyTo = (function (seq15776){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15776));
}));
