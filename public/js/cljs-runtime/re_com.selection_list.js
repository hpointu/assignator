...
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__15942 = "list-group-item";
var G__15943 = "compact";
var G__15944 = "rc-selection-list-group-item";
var G__15945 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"list-group-item","list-group-item",1978708789),new cljs.core.Keyword(null,"class","class",-2030961996)], null));
return (re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4 ? re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4(G__15942,G__15943,G__15944,G__15945) : re_com.theme.merge_class.call(null,G__15942,G__15943,G__15944,G__15945));
...
var num_selected_16019 = cljs.core.count(selections);
var only_item_16020 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),num_selected_16019))?cljs.core.first(selections):null);
if(((cljs.core.not(disabled_QMARK_)) && (cljs.core.not((function (){var and__5000__auto____$1 = required_QMARK_;
if(cljs.core.truth_(and__5000__auto____$1)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(only_item_16020,item_id);
} else {
...
var G__15952_16023 = cljs.core.disj.cljs$core$IFn$_invoke$arity$2(selections,item_id);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__15952_16023) : on_change.call(null,G__15952_16023));
} else {
var G__15953_16024 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(selections,item_id);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__15953_16024) : on_change.call(null,G__15953_16024));
}
} else {
}
...
var item_id = (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(item) : id_fn.call(null,item));
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__15963 = "list-group-item";
var G__15964 = "compact";
var G__15965 = "rc-selection-list-group-item";
var G__15966 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"list-group-item","list-group-item",1978708789),new cljs.core.Keyword(null,"class","class",-2030961996)], null));
return (re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4 ? re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4(G__15963,G__15964,G__15965,G__15966) : re_com.theme.merge_class.call(null,G__15963,G__15964,G__15965,G__15966));
})(),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"list-group-item","list-group-item",1978708789),new cljs.core.Keyword(null,"style","style",-496642736)], null),cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"attr","attr",-604132353),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (event){
if(cljs.core.truth_(disabled_QMARK_)){
} else {
if(cljs.core.truth_((function (){var and__5000__auto__ = required_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
...
var G__15974_16034 = re_com.selection_list.radio_clicked(selections,item_id);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__15974_16034) : on_change.call(null,G__15974_16034));
}
}
...
var len__5726__auto___16058 = arguments.length;
var i__5727__auto___16059 = (0);
while(true){
if((i__5727__auto___16059 < len__5726__auto___16058)){
args__5732__auto__.push((arguments[i__5727__auto___16059]));

var G__16060 = (i__5727__auto___16059 + (1));
i__5727__auto___16059 = G__16060;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});

(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__15994){
var map__15995 = p__15994;
var map__15995__$1 = cljs.core.__destructure_map(map__15995);
var args = map__15995__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),false);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"required?","required?",-872514462),false);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285),false);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922),false);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15995__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15995__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151),true);
var or__5002__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args));
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer__$1)?(function (p1__15985_SHARP_){
return (item_renderer__$1.cljs$core$IFn$_invoke$arity$8 ? item_renderer__$1.cljs$core$IFn$_invoke$arity$8(p1__15985_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1) : item_renderer__$1.call(null,p1__15985_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1));
}):(cljs.core.truth_(multi_select_QMARK___$1)?(function (p1__15986_SHARP_){
return re_com.selection_list.as_checked(p1__15986_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}):(function (p1__15987_SHARP_){
return re_com.selection_list.as_radio(p1__15987_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}))),choices__$1);
...
return new cljs.core.PersistentVector(null, 17, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,new cljs.core.Keyword(null,"src","src",-1651076051),src,new cljs.core.Keyword(null,"debug-as","debug-as",283322354),(function (){var or__5002__auto____$1 = debug_as;
...
})(),new cljs.core.Keyword(null,"class","class",-2030961996),["rc-selection-list ",(cljs.core.truth_(re_com.util.deref_or_value(disabled_QMARK___$1))?"rc-disabled":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),new cljs.core.Keyword(null,"style","style",-496642736),style,new cljs.core.Keyword(null,"attr","attr",-604132353),attr,new cljs.core.Keyword(null,"radius","radius",-2073122258),"4px",new cljs.core.Keyword(null,"border","border",1444987323),(cljs.core.truth_(hide_border_QMARK___$1)?"none":null),new cljs.core.Keyword(null,"child","child",623967545),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__16005 = "list-group";
var G__16006 = "noselect";
var G__16007 = "rc-selection-list-group";
var G__16008 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"list-group","list-group",-304522729),new cljs.core.Keyword(null,"class","class",-2030961996)], null));
return (re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4 ? re_com.theme.merge_class.cljs$core$IFn$_invoke$arity$4(G__16005,G__16006,G__16007,G__16008) : re_com.theme.merge_class.call(null,G__16005,G__16006,G__16007,G__16008));
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq15988){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15988));
}));
