...
var periods__$1 = cljs.core.vec((function (){var G__14909 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14907_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14907_SHARP_,(0),(3));
}),G__14909);
} else {
return G__14909;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__14928){
var vec__14929 = p__14928;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14929,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14929,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__14932 = pattern;
switch (G__14932) {
case "S":
...
var G__14944 = key;
var G__14944__$1 = (((G__14944 instanceof cljs.core.Keyword))?G__14944.fqn:null);
switch (G__14944__$1) {
case "millis":
return (function (p1__14934_SHARP_){
return p1__14934_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__14935_SHARP_){
return p1__14935_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__14936_SHARP_){
return p1__14936_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__14937_SHARP_){
return p1__14937_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__14938_SHARP_){
return p1__14938_SHARP_.getHours();
});

break;
case "day":
return (function (p1__14939_SHARP_){
return p1__14939_SHARP_.getDate();
});

break;
case "month":
return (function (p1__14940_SHARP_){
return p1__14940_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__14941_SHARP_){
return p1__14941_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14944__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__14945){
var vec__14946 = p__14945;
var seq__14947 = cljs.core.seq(vec__14946);
var first__14948 = cljs.core.first(seq__14947);
var seq__14947__$1 = cljs.core.next(seq__14947);
var key = first__14948;
var args = seq__14947__$1;
var G__14950 = key;
...
break;
case "ordinal-suffix":
var vec__14952 = (function (){var G__14955 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__14955) : syntax_list.call(null,G__14955));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14950__$1)].join('')));
...
var d = value;
var G__14959 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__14960 = G__14959;
...
var unparser = first__14962;
var more = seq__14961__$1;
var s = "";
var d__$1 = d;
var G__14959__$1 = G__14959;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__14969 = G__14959__$1;
var seq__14970 = cljs.core.seq(vec__14969);
var first__14971 = cljs.core.first(seq__14970);
var seq__14970__$1 = cljs.core.next(seq__14970);
var unparser__$1 = first__14971;
var more__$1 = seq__14970__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__14972 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14972,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14972,(1),null);
var G__15027 = d__$3;
var G__15028 = more__$1;
var G__15029 = s__$3;
d__$1 = G__15027;
G__14959__$1 = G__15028;
s__$1 = G__15029;
continue;
}
break;
