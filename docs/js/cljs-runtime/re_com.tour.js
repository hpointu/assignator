...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16073_SHARP_,p2__16074_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__16073_SHARP_,p2__16074_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5480__auto__ = (function re_com$tour$initialise_tour_$_iter__16078(s__16079){
return (new cljs.core.LazySeq(null,(function (){
var s__16079__$1 = s__16079;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__16079__$1);
if(temp__5804__auto__){
var s__16079__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16079__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__16079__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__16081 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__16080 = (0);
while(true){
if((i__16080 < size__5479__auto__)){
var step = cljs.core._nth(c__5478__auto__,i__16080);
cljs.core.chunk_append(b__16081,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__16131 = (i__16080 + (1));
i__16080 = G__16131;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16081),re_com$tour$initialise_tour_$_iter__16078(cljs.core.chunk_rest(s__16079__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16081),null);
}
} else {
var step = cljs.core.first(s__16079__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__16078(cljs.core.rest(s__16079__$2)));
}
} else {
return null;
}
...
return iter__5480__auto__(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
...
return cljs.core.reset_BANG_((function (){var fexpr__16095 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__16095.cljs$core$IFn$_invoke$arity$1 ? fexpr__16095.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__16095.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__16098 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__16098.cljs$core$IFn$_invoke$arity$1 ? fexpr__16098.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__16098.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__16100 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__16100.cljs$core$IFn$_invoke$arity$1 ? fexpr__16100.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__16100.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__16106 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__16106.cljs$core$IFn$_invoke$arity$1 ? fexpr__16106.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__16106.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__16107 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__16107.cljs$core$IFn$_invoke$arity$1 ? fexpr__16107.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__16107.call(null,tour));
})(),true);
} else {
return null;
}
