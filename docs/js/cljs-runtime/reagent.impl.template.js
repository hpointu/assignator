...
var G__12125 = o;
reagent.impl.template.goog$module$goog$object.set(G__12125,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12127 = o;
reagent.impl.template.goog$module$goog$object.set(G__12127,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__12131 = props;
var G__12131__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12131,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12131);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12131__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12132 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12132,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12132;
}
})(),id_class);
...
var temp__5804__auto___12153 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___12153)){
var d_12154 = temp__5804__auto___12153;
if((d_12154 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_12154.s}));
} else {
...
var G__12133 = (cljs.core.count(argv) - first_child);
switch (G__12133) {
case (0):
...
var vec__12134 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12134,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12134,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12134,(2),null);
...
var temp__5808__auto___12156 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___12160 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12160 == null)){
} else {
var key_12161 = temp__5808__auto___12160;
(jsprops.key = key_12161);
}
...
var temp__5808__auto___12164 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12164 == null)){
} else {
var key_12165 = temp__5808__auto___12164;
(jsprops.key = key_12165);
}
...
var temp__5808__auto___12174 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12174 == null)){
} else {
var key_12175 = temp__5808__auto___12174;
(jsprops.key = key_12175);
}
...
var temp__5808__auto___12179 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12179 == null)){
} else {
var key_12181 = temp__5808__auto___12179;
(jsprops.key = key_12181);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12137_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12137_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12138 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12138,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12138,(1),null);
...
break;
default:
var G__12191 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12192 = compiler;
v = G__12191;
compiler = G__12192;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12144 = (function (opts,id,fn_to_element,parse_fn,meta12145){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta12145 = meta12145;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template12144.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12146,meta12145__$1){
var self__ = this;
var _12146__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12144(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12145__$1));
}));

(reagent.impl.template.t_reagent$impl$template12144.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12146){
var self__ = this;
var _12146__$1 = this;
return self__.meta12145;
}));

(reagent.impl.template.t_reagent$impl$template12144.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12144.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12144.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12144.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12144.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12144.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12145","meta12145",581253602,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12144.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12144.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12144");

(reagent.impl.template.t_reagent$impl$template12144.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12144");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12144.
 */
reagent.impl.template.__GT_t_reagent$impl$template12144 = (function reagent$impl$template$__GT_t_reagent$impl$template12144(opts,id,fn_to_element,parse_fn,meta12145){
return (new reagent.impl.template.t_reagent$impl$template12144(opts,id,fn_to_element,parse_fn,meta12145));
});
...
return (new reagent.impl.template.t_reagent$impl$template12144(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
